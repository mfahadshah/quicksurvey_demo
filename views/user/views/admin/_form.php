...
array_unshift($timezones, "UTC +00:00");

// Default timezone
$profile->timezone = empty($profile->timezone) ? Yii::$app->user->identity->profile->timezone : $profile->timezone;

// Default language
$profile->language = empty($profile->language) ? Yii::$app->user->identity->profile->language : $profile->language;
