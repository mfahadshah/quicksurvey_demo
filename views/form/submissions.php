                            ...
                            <tr class="info">
                                <th colspan="2">
                                    ...
                                    <div class="pull-right emptyFields" style="font-weight: normal; font-size: 70%">
                                        <input type="checkbox" id="showEmptyFields" style="vertical-align: middle; margin: 0" {{= showEmptyFields }} />
                                        <label for="showEmptyFields" class="checkbox-inline" style="font-size: 12px; margin: 0; padding: 0;">
